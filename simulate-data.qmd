...
randomeffects <- data.frame(country, GII, u0, u1) # dataframe of random effects
...
pander::pander(labelled::look_for(MICSsimulated)[1:5]) # list out variable labels
...
#| code-summary: "Show the code"
#| label: tbl-fit1
#| tbl-cap: Multilevel Logistic Regression
#| warning: false
